...
require_once '../core/conection.php';
  ...
  if(isset($_POST['cadastrar'])){
    ...
    $tipoCampeonato = filter_input(INPUT_POST, 'tipoCampeonato');
    ...
    $guarda = $pdo->prepare("INSERT INTO campeonatos(Campeonato, PaisId, DesportoId, tipoCampeonato) VALUES('$nome', '$id', '$idD', '$tipoCampeonato')");
                ...
                <?php
                        ...
                        echo '
                            ...
                            <thead>
                                ...
                                <th scope="col" class="sort" data-sort="">Tipo de Campeonato</th>
                        ...
                        { 
                          ...
                          <td>'. $campeonato['tipoCampeonato'].'</td>
                  ...
                  <div class="modal-content text-center">
                    <div class="modal-header text-center">
                        ...
                        <form action="" method="post" class="form">
                          ...
                          <select name="tipoCampeonato" id="">
                              <option value="" desable>Tipo de Campionato</option>
